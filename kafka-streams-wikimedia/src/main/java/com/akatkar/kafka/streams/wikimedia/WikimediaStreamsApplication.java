package com.akatkar.kafka.streams.wikimedia;
...
import com.akatkar.kafka.streams.wikimedia.processor.BotCountStreamBuilder;
import com.akatkar.kafka.streams.wikimedia.processor.EventCountTimeSeriesBuilder;
import com.akatkar.kafka.streams.wikimedia.processor.WebsiteCountStreamBuilder;

public class WikimediaStreamsApplication {
    private static final Logger LOGGER = LoggerFactory.getLogger(WikimediaStreamsApplication.class);
